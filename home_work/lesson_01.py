...
while True:
    ...
    if user_input == "":
        ...
        print("First letter capitalized:".ljust(30), user_input.lower().capitalize())
        print("All lowercase:".ljust(30), user_input.lower())
        print("All uppercase:".ljust(30), user_input.upper())
        print("Title case:".ljust(30), user_input.lower().title())
